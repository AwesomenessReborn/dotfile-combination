...
-- start custom indent settings
vim.o.tabstop = 4 -- Number of visual spaces per tab character.
vim.o.shiftwidth = 4 -- Number of spaces to use for auto-indent operations.
vim.o.softtabstop = 4 -- Number of spaces the <Tab> key inserts.
vim.o.expandtab = true -- Use spaces instead of actual tab characters.
-- END custom indent settings
